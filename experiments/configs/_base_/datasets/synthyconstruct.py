# dataset settings
dataset_type = 'SynthCon'
data_root = '/path/before/image-gt/folders'
img_norm_cfg = dict(
    mean=[108.150, 106.586, 104.614], std=[57.4877, 57.4082, 60.4956], to_rgb=True)  # values based on the real dataset in this work
crop_size = (224, 224)
train_pipeline = [
